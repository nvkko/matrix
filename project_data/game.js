...
var txt_i = 0, timer = 0, step = 0, step2 = 0, link_time = false;
const G = {
...
function link_click() {
  if(link_time){
    var hover = hover_link(data.thirdTxt);
    if(hover){
      _link.click();
      //window.open('https://www.brainteasersnetwork.com/', '_blank');
...
can.addEventListener("mousedown", link_click, !1);
/* Touches */can.addEventListener("touchstart", link_click, !1);
